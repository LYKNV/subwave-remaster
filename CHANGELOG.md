...
## [0.31.0](https://github.com/LYKNV/subwave-remaster/compare/v0.30.0...v0.31.0) (2026-06-27)
...
* admin archives, listener history, outbound webhooks ([#119](https://github.com/LYKNV/subwave-remaster/issues/119)) ([f0389e5](https://github.com/LYKNV/subwave-remaster/commit/f0389e599c1150af243472af9e16e1301a4a7948))
* **admin/library:** tidy KPI grid and slim tracks table ([4e7d376](https://github.com/LYKNV/subwave-remaster/commit/4e7d376d897379951cdada316b89fa7cf85163fa))
...
* **admin:** admin field for station + dashboard/settings polish ([ff1e558](https://github.com/LYKNV/subwave-remaster/commit/ff1e558718f431e02f0c432af984d8407a56b452))
...
* **admin:** archives index, listener history, outbound webhooks ([#114](https://github.com/LYKNV/subwave-remaster/issues/114)) ([af3ddda](https://github.com/LYKNV/subwave-remaster/commit/af3dddabbbd236dee8754dedbec692d2fe8db7c5))
* **admin:** audio preview for jingles and sound effects ([#141](https://github.com/LYKNV/subwave-remaster/issues/141)) ([005983b](https://github.com/LYKNV/subwave-remaster/commit/005983bbc7e29d5c751a48c9a72b3cc9e6670900))
...
* **admin:** redo library page with working filters + coverage ([f7aaa65](https://github.com/LYKNV/subwave-remaster/commit/f7aaa65eba60f0b8bdd1a456600631d7e4baed3f))
* **admin:** redo library page with working filters + coverage ([417b61a](https://github.com/LYKNV/subwave-remaster/commit/417b61a39129a125b5939f164cb307ed3c872ffd))
...
* AI DJ capabilities — daypart energy, cross-hour memory, DJ mode + track analysis ([#216](https://github.com/LYKNV/subwave-remaster/issues/216)) ([#228](https://github.com/LYKNV/subwave-remaster/issues/228)) ([ba79a53](https://github.com/LYKNV/subwave-remaster/commit/ba79a5398c890f5e4d10bfdde278347cf9fa62d7))
...
* **broadcast:** add Ogg-Opus stream alongside MP3 ([#142](https://github.com/LYKNV/subwave-remaster/issues/142)) ([c542285](https://github.com/LYKNV/subwave-remaster/commit/c542285c6eb619c0e7f563ff03bcdc93c67d764b))
...
* **cli:** fetch TUI binary on demand for standalone installs ([f621d76](https://github.com/LYKNV/subwave-remaster/commit/f621d7669390a1df8b7a3d238fa9f417112dddba))
* **cli:** fetch TUI binary on demand for standalone installs ([960c90d](https://github.com/LYKNV/subwave-remaster/commit/960c90d04d5932b9f80fdc7e6dfc82a43e59eb34))
* **cli:** full-stack restart option + fix rebuild on standalone installs ([809f835](https://github.com/LYKNV/subwave-remaster/commit/809f835c2cf0919ecc158bc2941b7c17ea759092))
* **cli:** subwave uninstall + version-mismatch warning ([#211](https://github.com/LYKNV/subwave-remaster/issues/211)) ([f8dd506](https://github.com/LYKNV/subwave-remaster/commit/f8dd5062952fd8fe000d9ec88684636cb5e85c9b))
* **cli:** surface incomplete setup as a doctor finding ([fee3466](https://github.com/LYKNV/subwave-remaster/commit/fee346651aa1e8f0c0437802ef899f539b85765a))
* **cli:** wire `setup` through /onboarding/save + highlight Listen/Admin ([a414840](https://github.com/LYKNV/subwave-remaster/commit/a414840f3358b6d76de9f4b8008429ebec623a3e))
* **controller:** add curiosity, album-anniversary, library-deep-cut skills ([3999f63](https://github.com/LYKNV/subwave-remaster/commit/3999f636335c1397a59676dbb3bf09bb28118089))
* **controller:** add curiosity, album-anniversary, library-deep-cut skills ([aa3913e](https://github.com/LYKNV/subwave-remaster/commit/aa3913e19f2ac324d3ea52c03c9f992284aab2c0))
* **controller:** embedding-propagated library tagger (SQLite + sqlite-vec) ([#157](https://github.com/LYKNV/subwave-remaster/issues/157)) ([ec406b7](https://github.com/LYKNV/subwave-remaster/commit/ec406b79d9b4600272440ce49ef47b5bfbb312ba))
...
* **controller:** support imperial weather units ([6fb24e2](https://github.com/LYKNV/subwave-remaster/commit/6fb24e243c3ea05609a8566cdebfc82174e16239)), closes [#173](https://github.com/LYKNV/subwave-remaster/issues/173)
* **controller:** support imperial weather units (closes [#173](https://github.com/LYKNV/subwave-remaster/issues/173)) ([efba9dc](https://github.com/LYKNV/subwave-remaster/commit/efba9dcaab371592033c791011c2635c5707c3f0))
...
* **docker:** merge icecast + liquidsoap into one `broadcast` image ([0efa8b4](https://github.com/LYKNV/subwave-remaster/commit/0efa8b4c047f6641f79e778465d80ad33839ec5c))
...
* **personas+player:** persona avatars + listener Schedule drawer ([a219fd9](https://github.com/LYKNV/subwave-remaster/commit/a219fd9e7f6df6104ae71471dba71f821a4a924a))
* **personas+player:** persona avatars + listener Schedule drawer ([40701a2](https://github.com/LYKNV/subwave-remaster/commit/40701a24f11768f0d7a1c2eb2ea1543710234608))
* **personas:** Generate button — random DiceBear avatar in admin ([#186](https://github.com/LYKNV/subwave-remaster/issues/186)) ([53373ca](https://github.com/LYKNV/subwave-remaster/commit/53373ca66e1090d2aed16910cc4a1888e16bf910))
...
* **player:** per-show theme override + manual page ([3ff52bb](https://github.com/LYKNV/subwave-remaster/commit/3ff52bbb3df4448e3eff4676d359560dac93dc95))
...
* **player:** station-wide visual themes ([433ab98](https://github.com/LYKNV/subwave-remaster/commit/433ab98aaca50bebc3454cf60b643c6e92a421e5))
* **player:** station-wide visual themes ([5967bef](https://github.com/LYKNV/subwave-remaster/commit/5967befa33cc83d9f6fb76a0dc5221ccd71ba5ce))
* scrobble to Last.fm and ListenBrainz ([#121](https://github.com/LYKNV/subwave-remaster/issues/121)) ([#126](https://github.com/LYKNV/subwave-remaster/issues/126)) ([fb76507](https://github.com/LYKNV/subwave-remaster/commit/fb765078890d336a6ee0caa831f75f0f2e45c7d8))
...
* **skills:** operator-pluggable custom skills via state/skills ([#210](https://github.com/LYKNV/subwave-remaster/issues/210)) ([dc193f3](https://github.com/LYKNV/subwave-remaster/commit/dc193f3171c3676c49974bd30f496db2835fbab8))
...
* **tts:** per-persona custom Piper voices via drop-in .onnx files ([#232](https://github.com/LYKNV/subwave-remaster/issues/232)) ([865c3e9](https://github.com/LYKNV/subwave-remaster/commit/865c3e9c95ea025ec20a5baabdd293e1e8e9bf77)), closes [#230](https://github.com/LYKNV/subwave-remaster/issues/230)
* **tts:** shared voice folder + PocketTTS cloning + scrollable voice select ([#213](https://github.com/LYKNV/subwave-remaster/issues/213)) ([#217](https://github.com/LYKNV/subwave-remaster/issues/217)) ([c4dcac4](https://github.com/LYKNV/subwave-remaster/commit/c4dcac47ecbd22233c77f467604946489c00f0cf))
* **tts:** tts-heavy sidecar for Chatterbox + PocketTTS ([#110](https://github.com/LYKNV/subwave-remaster/issues/110)) ([419c25d](https://github.com/LYKNV/subwave-remaster/commit/419c25d1ca937a6a48943ff6979bd1d2146cc132))
...
* **web/player:** tactile press + haptics on transport controls ([7779424](https://github.com/LYKNV/subwave-remaster/commit/77794248626b2e8e7e9f497165122e75d719ab91))
...
* **web:** add news "Dispatches" page with markdown articles ([#223](https://github.com/LYKNV/subwave-remaster/issues/223)) ([4a221f0](https://github.com/LYKNV/subwave-remaster/commit/4a221f085d40a0de88617116f6898ff79925659b))
...
* **web:** add Re-seed embeddings button to admin Library tab ([#239](https://github.com/LYKNV/subwave-remaster/issues/239)) ([710fd30](https://github.com/LYKNV/subwave-remaster/commit/710fd30484bbcb75b6cd7972d23087f1903a21d9)), closes [#237](https://github.com/LYKNV/subwave-remaster/issues/237)
...
* **web:** haptic feedback on drawer open/close ([345d6f8](https://github.com/LYKNV/subwave-remaster/commit/345d6f851566c924e4a8a3d28b9b3f89e04e3e2a))
* **web:** haptic feedback on drawer open/close ([bab87c0](https://github.com/LYKNV/subwave-remaster/commit/bab87c0893fe2fc592b31256d9f5273203f45165))
...
* **web:** per-listener theme switcher in player + admin headers ([#188](https://github.com/LYKNV/subwave-remaster/issues/188)) ([22cc7d9](https://github.com/LYKNV/subwave-remaster/commit/22cc7d9b436a6c1f9ecc55afc8721b836b6e2098))
* **web:** prominent setup guide for uninstalled heavy TTS engines ([#220](https://github.com/LYKNV/subwave-remaster/issues/220)) ([d8a3b60](https://github.com/LYKNV/subwave-remaster/commit/d8a3b6083623d4b387aa9f5718bc389cee185d9b))
...
* **web:** reorder admin settings sidebar with Station first ([#219](https://github.com/LYKNV/subwave-remaster/issues/219)) ([75ae565](https://github.com/LYKNV/subwave-remaster/commit/75ae565c72f986401122f0c814aef38118eecdb3))
* **web:** ripple effect behind now-playing artwork ([#129](https://github.com/LYKNV/subwave-remaster/issues/129)) ([d4e3819](https://github.com/LYKNV/subwave-remaster/commit/d4e38199f938d0f626370ed33bca211585fdfc9e))
* **web:** show 'engine off' on acoustic analysis meter when no DSP backend ([#235](https://github.com/LYKNV/subwave-remaster/issues/235)) ([9751fc5](https://github.com/LYKNV/subwave-remaster/commit/9751fc52412365c7e43a9542956b3af1925bc0ce))
...
* **web:** show station time and location on Schedule tab ([#187](https://github.com/LYKNV/subwave-remaster/issues/187)) ([5a4ca33](https://github.com/LYKNV/subwave-remaster/commit/5a4ca330e69a6f7f680a91b61221cf02b949165b))
...
* **admin:** keep /admin/debug expansions from blowing out the viewport ([de9b64f](https://github.com/LYKNV/subwave-remaster/commit/de9b64fe7d8412d9770e0c36227f10b6aa6dbade))
* **admin:** keep /admin/debug expansions from blowing out viewport ([37764b2](https://github.com/LYKNV/subwave-remaster/commit/37764b2f2fa96489fdc6949adffc558471a14962))
...
* **broadcast:** expand strftime in hourly archive path ([358cb94](https://github.com/LYKNV/subwave-remaster/commit/358cb9481ea6f6c05651a720f7443011fc0d835c))
* **broadcast:** expand strftime in hourly archive path ([bc00d5c](https://github.com/LYKNV/subwave-remaster/commit/bc00d5cf63793a853815e5b8c76c1cc4e3e4bcf3))
* **broadcast:** fatten Icecast burst + queue buffers to cut mobile stalls ([#224](https://github.com/LYKNV/subwave-remaster/issues/224)) ([e421fe4](https://github.com/LYKNV/subwave-remaster/commit/e421fe433f761b8725033babee489817abf86144))
...
* **caddy:** use named matcher for multi-path stream handle ([9ae0471](https://github.com/LYKNV/subwave-remaster/commit/9ae0471a90dde7aad79bd22d4923a99ef893faf8))
* **caddy:** use named matcher for multi-path stream handle ([bdb98d8](https://github.com/LYKNV/subwave-remaster/commit/bdb98d8912cdb7733be2de57dd71721bae406de7))
* **ci:** pin release-please target-branch to main ([9138de0](https://github.com/LYKNV/subwave-remaster/commit/9138de0cd8cb064270f91aa8a7972fbfc2b6a3a6))
* **ci:** pin release-please target-branch to main + restore conventional history ([db33b3b](https://github.com/LYKNV/subwave-remaster/commit/db33b3beaa2464ec3160b59491a19d6c8f471c06))
* **cli:** bypass Bun's broken macOS stdin in curl|sh flow ([#165](https://github.com/LYKNV/subwave-remaster/issues/165)) ([6bb5bb5](https://github.com/LYKNV/subwave-remaster/commit/6bb5bb58473341d709fcde51b7b6a6abac23d468))
* **cli:** declare tsx as a devDependency ([2c18532](https://github.com/LYKNV/subwave-remaster/commit/2c185322ebba20a11de89ea7bd65121f24c2d608))
...
* **cli:** single-quote .env values + docker-group hint ([#156](https://github.com/LYKNV/subwave-remaster/issues/156)) ([10c115d](https://github.com/LYKNV/subwave-remaster/commit/10c115d04712138265e03055aec6bf1e425982c1))
...
* **controller/picker:** stop deterministic track/artist clustering ([#115](https://github.com/LYKNV/subwave-remaster/issues/115)) ([070bc3d](https://github.com/LYKNV/subwave-remaster/commit/070bc3d7c65c779b876ddec00212b514eac308c8))
* **controller:** air DJ intros/links when their track starts, not one early ([#189](https://github.com/LYKNV/subwave-remaster/issues/189)) ([#191](https://github.com/LYKNV/subwave-remaster/issues/191)) ([63055f2](https://github.com/LYKNV/subwave-remaster/commit/63055f200794c1deb3feadbfc0c40ee25d41001e))
* **controller:** dj-agent recovery returns valid ids + pick.rejected observability ([#199](https://github.com/LYKNV/subwave-remaster/issues/199)) ([ff4c22e](https://github.com/LYKNV/subwave-remaster/commit/ff4c22e152088e380914bdabb311c93ab578bafb))
...
* **controller:** harden DJ segments against transient LLM/IPC failures ([#140](https://github.com/LYKNV/subwave-remaster/issues/140)) ([#145](https://github.com/LYKNV/subwave-remaster/issues/145)) ([6a560c9](https://github.com/LYKNV/subwave-remaster/commit/6a560c962f374b5747954cd3da68540362c03b8e))
* **controller:** include station in /now-playing dj block so player header shows it ([d1a1b01](https://github.com/LYKNV/subwave-remaster/commit/d1a1b014e316d55b846d017c052cfba276067997))
...
* **controller:** raise global JSON body limit so persona avatar uploads work ([f7f809f](https://github.com/LYKNV/subwave-remaster/commit/f7f809f2921f605de1c3a372e807bf6a73f34511))
* **controller:** raise global JSON body limit so persona avatar uploads work ([09ddbd0](https://github.com/LYKNV/subwave-remaster/commit/09ddbd014ecd9169e9352fd0997b2cda76ee3c6e))
...
* honour configured station name in DJ speech + Icecast mounts ([317aec8](https://github.com/LYKNV/subwave-remaster/commit/317aec87a12a17cbd9ca34f0fdf9523b4742b78e))
* honour configured station name in DJ speech + Icecast mounts ([098b98c](https://github.com/LYKNV/subwave-remaster/commit/098b98ca75d8a0ef59c7d30eb6ca7ba919aab735))
* **landing:** tighten masthead nav bottom padding ([6856661](https://github.com/LYKNV/subwave-remaster/commit/685666130a2745103d1c66856557c321b7b7e854))
* **landing:** tighten masthead nav bottom padding ([9c99bd9](https://github.com/LYKNV/subwave-remaster/commit/9c99bd9ac9960c9918c87eabd0b4187706c9fa37))
...
* macOS curl|sh installer hang + publish multi-arch (arm64) images ([#206](https://github.com/LYKNV/subwave-remaster/issues/206)) ([e782ca0](https://github.com/LYKNV/subwave-remaster/commit/e782ca0058df53b02dd54fcb29e1ebed99dbc047))
...
* **onboarding:** retrigger auto-playlist refresh after save ([4544f07](https://github.com/LYKNV/subwave-remaster/commit/4544f07c80f4e86a71eec6b616341856bb3b279e))
* persist station name from setup wizard ([#102](https://github.com/LYKNV/subwave-remaster/issues/102)) + admin polish ([f089c5b](https://github.com/LYKNV/subwave-remaster/commit/f089c5bf090d49e2c051a3cb50ea0139bb2d9cd2))
* persist station name from setup wizard end-to-end ([f3e1941](https://github.com/LYKNV/subwave-remaster/commit/f3e1941eaf71411ae0afaa278ab88911ce7f2fc9)), closes [#102](https://github.com/LYKNV/subwave-remaster/issues/102)
...
* **player:** show configured station name + lead DotRail with Schedule ([ad8474a](https://github.com/LYKNV/subwave-remaster/commit/ad8474ac16ad82416959ee8120ff03281108f2d3))
...
* **setup:** auto-detect host timezone on fresh installs ([#205](https://github.com/LYKNV/subwave-remaster/issues/205)) ([#214](https://github.com/LYKNV/subwave-remaster/issues/214)) ([96defbd](https://github.com/LYKNV/subwave-remaster/commit/96defbdadf37380244aa2e1f05d0c76906a68095))
* **setup:** drop stale setup-config cache to honour out-of-band writes ([ae64859](https://github.com/LYKNV/subwave-remaster/commit/ae6485947919dd30edb51a6a3b656321025f2a8a))
...
* **skill:** worktree-dev prep mirrors operator's declarative state ([f433bb5](https://github.com/LYKNV/subwave-remaster/commit/f433bb583a99b86584d47ac2a2e9769a54749878))
* **skill:** worktree-dev prep skips onboarding and follows root compose layout ([#127](https://github.com/LYKNV/subwave-remaster/issues/127)) ([b59d41e](https://github.com/LYKNV/subwave-remaster/commit/b59d41e6337d41a7fe2a86bcaa93bacd885e70b5))
...
* **tagger:** friendly preflight + auto-pull for embedding failures ([d980f9d](https://github.com/LYKNV/subwave-remaster/commit/d980f9d79f068b924c7d5237cbed35b724cf020c))
* **tagger:** friendly preflight + auto-pull for embedding failures ([3721b1b](https://github.com/LYKNV/subwave-remaster/commit/3721b1ba37338a950206483fa3fa65974014e0f9))
...
* **tagger:** load wizard config in tag-library CLI ([#123](https://github.com/LYKNV/subwave-remaster/issues/123)) ([b974eb9](https://github.com/LYKNV/subwave-remaster/commit/b974eb96485a367b45541b984190fdb4222ea805)), closes [#122](https://github.com/LYKNV/subwave-remaster/issues/122)
...
* **tts:** make PocketTTS voice cloning work + surface when it can't ([#238](https://github.com/LYKNV/subwave-remaster/issues/238)) ([#240](https://github.com/LYKNV/subwave-remaster/issues/240)) ([2ebbec8](https://github.com/LYKNV/subwave-remaster/commit/2ebbec8c9ff0b2c1789d52545ec7707dcb31e559))
...
* **web,controller:** show configured station name in admin form and player header ([#117](https://github.com/LYKNV/subwave-remaster/issues/117)) ([6f13d4a](https://github.com/LYKNV/subwave-remaster/commit/6f13d4a6904c5f0a056dee219485513b1ee84f11))
* **web/landing:** stop mobile horizontal scroll from rotating DJ glyph ([c129c82](https://github.com/LYKNV/subwave-remaster/commit/c129c823d6bfcd55b2011b3ac8e9fcd1e8d960bc))
* **web:** admin UI polish — Library default tab + tagger strip, Dash & Personas layout ([#195](https://github.com/LYKNV/subwave-remaster/issues/195)) ([bbe69c8](https://github.com/LYKNV/subwave-remaster/commit/bbe69c8efa011548b0dc8cd2663442c27f479b7b))
* **web:** allow saving PocketTTS personas with a cloned .wav voice ([#231](https://github.com/LYKNV/subwave-remaster/issues/231)) ([51a2423](https://github.com/LYKNV/subwave-remaster/commit/51a242369b093636a60c4c2e6ec6e422e5c5b969))
...
* **web:** compress persona avatar to WebP so normal images upload ([#190](https://github.com/LYKNV/subwave-remaster/issues/190)) ([b433a1a](https://github.com/LYKNV/subwave-remaster/commit/b433a1a94f25a5ea747bd6fc9f8e3f3f2ce84d68))
...
* **web:** drop 'newsprint v3' line from admin console footer ([#196](https://github.com/LYKNV/subwave-remaster/issues/196)) ([41159ae](https://github.com/LYKNV/subwave-remaster/commit/41159aee2f1ec860f74173c9246e7ed44ab8ab32))
* **web:** drop dead T theme shortcut, document 4 → Schedule in player help ([#198](https://github.com/LYKNV/subwave-remaster/issues/198)) ([c7df977](https://github.com/LYKNV/subwave-remaster/commit/c7df9776b665d3e36d221921aea51d3f3675f121))
* **web:** keep Firefox on MP3 mount (Opus goes silent on track change) ([#215](https://github.com/LYKNV/subwave-remaster/issues/215)) ([8fdb0c9](https://github.com/LYKNV/subwave-remaster/commit/8fdb0c93b5b9410840730b25846dd389d3d66e3b)), closes [#212](https://github.com/LYKNV/subwave-remaster/issues/212)
...
* **web:** keep Safari iOS on MP3 and auto-reconnect stalled &lt;audio&gt; ([861b68f](https://github.com/LYKNV/subwave-remaster/commit/861b68fd946e559dcdcdb97a646eae3079be073f))
* **web:** keep Safari iOS on MP3 and auto-reconnect stalled audio ([2c1a439](https://github.com/LYKNV/subwave-remaster/commit/2c1a439b2ec486d269774ab043233934c985791a))
...
* **web:** mobile layout regressions in admin panels ([c03fc33](https://github.com/LYKNV/subwave-remaster/commit/c03fc33dde1eecc15430180a41aea675cbfb75a7))
* **web:** mobile layout regressions in admin panels ([d210b1e](https://github.com/LYKNV/subwave-remaster/commit/d210b1ef863f44b7511ab0ebfea86d5d6f1f2b33))
* **web:** move Schedule above Timeline in the player DotRail ([e99d581](https://github.com/LYKNV/subwave-remaster/commit/e99d58125da8523a5909c325a24fca179ab04756))
* **web:** order news newest-first with human-friendly dates ([#241](https://github.com/LYKNV/subwave-remaster/issues/241)) ([9a62423](https://github.com/LYKNV/subwave-remaster/commit/9a6242350922ad876f0532cb883688e2be11be76))
...
* **web:** split bundled command copy boxes, strip box comments ([#204](https://github.com/LYKNV/subwave-remaster/issues/204)) ([02531af](https://github.com/LYKNV/subwave-remaster/commit/02531af41f17825dadd559e63c3a5fc7d2d301e2))
* **web:** theme picker opacity + schedule time/location in autonomous mode ([#194](https://github.com/LYKNV/subwave-remaster/issues/194)) ([e7fce92](https://github.com/LYKNV/subwave-remaster/commit/e7fce9244ffa476c2879b9567dcdcff1c454bbc7))
* **web:** tighten landing hero spacing, single-rule credits strip ([#203](https://github.com/LYKNV/subwave-remaster/issues/203)) ([da03123](https://github.com/LYKNV/subwave-remaster/commit/da031236acaa520fe8f1d4a389a9cc3a39df75cc))
...
* **web:** unblock image build — ripple.tsx tailwind order + inline-style lint ([b5b4dea](https://github.com/LYKNV/subwave-remaster/commit/b5b4dea523689b95831317bf818ad4cc4e3bae7e))
...
* **web:** wrap long DJ thinking line on narrow screens ([22fc061](https://github.com/LYKNV/subwave-remaster/commit/22fc0619d8e6f490fb9825ff9ffa28cbd2722764))
* **web:** wrap long DJ thinking line on narrow screens ([20e6af6](https://github.com/LYKNV/subwave-remaster/commit/20e6af67edf54b03d1d0e72b0be2387b8e6a0b09))


### Performance

* **broadcast:** drop log verbosity and make hourly archive toggleable ([#139](https://github.com/LYKNV/subwave-remaster/issues/139)) ([d642d84](https://github.com/LYKNV/subwave-remaster/commit/d642d84b6cd56e605d6e0d66c37def80e9a3f3e4))
...
* **web:** restore pseudo-random waveform fallback for iOS Safari ([4d47925](https://github.com/LYKNV/subwave-remaster/commit/4d4792584ce609ef6cebcd88d27d6b73fe8ae82c))
* **web:** restore pseudo-random waveform fallback for iOS Safari ([3b7b9bd](https://github.com/LYKNV/subwave-remaster/commit/3b7b9bd655803213ed5f8996df15cdbce34963b8))
...
* plan to swap Ollama provider to ai-sdk-ollama ([30e27b8](https://github.com/LYKNV/subwave-remaster/commit/30e27b8ebfa209e4dcaded7203633a63a6ed37dd))
...
* **readme:** humanize prose, add Features section, fix stale facts ([0b4256a](https://github.com/LYKNV/subwave-remaster/commit/0b4256a4b27b88a98932d6c491ec8335741aa6ca))
* **readme:** humanize prose, add Features section, fix stale facts ([afda8ff](https://github.com/LYKNV/subwave-remaster/commit/afda8ffa816fd53a07b69f46000184bc188196c3))
* **setup:** align with merged broadcast container ([#125](https://github.com/LYKNV/subwave-remaster/issues/125)) ([ccd44d7](https://github.com/LYKNV/subwave-remaster/commit/ccd44d77da4c07901c0afb823096b393823850c8))
* **skill:** add back-merge step to subwave-release-pr skill ([#209](https://github.com/LYKNV/subwave-remaster/issues/209)) ([11030ba](https://github.com/LYKNV/subwave-remaster/commit/11030ba043a1c73deca45d06f6fd09858221f2f3))
...
* **skill:** warn against squash-merging release PRs ([8777cd0](https://github.com/LYKNV/subwave-remaster/commit/8777cd0502d20e9b35ad5287a26fc293cf1cc7c5))
...
* **web:** thin em-dash density in manual and setup pages ([#200](https://github.com/LYKNV/subwave-remaster/issues/200)) ([34b3b78](https://github.com/LYKNV/subwave-remaster/commit/34b3b782a5789c7f0c3a8ce98a1ad1c1c0701419))


### Refactors

* **admin:** rename Mixer section to Station, move Crossfade to Danger zone ([#128](https://github.com/LYKNV/subwave-remaster/issues/128)) ([56b1135](https://github.com/LYKNV/subwave-remaster/commit/56b11351a7cec688c5832d003465f542156b2c8b))
...
* **onboarding:** default Ollama model to glm-5.1:cloud, drop DJ prompt field ([ccd2ac9](https://github.com/LYKNV/subwave-remaster/commit/ccd2ac974d286f5eba62e791b4ffa30bdc007d45))
* **settings:** split shows + schedule into state/schedule.json ([#162](https://github.com/LYKNV/subwave-remaster/issues/162)) ([c5e454e](https://github.com/LYKNV/subwave-remaster/commit/c5e454ec0cd27f2ab33e4e4342ec7c24c47b1487))
